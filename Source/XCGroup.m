...
//This is an added function. From: https://github.com/appsquickly/XcodeEditor/issues/62
- (void)removeEmbeddedFramework:(XCFrameworkDefinition *)framework fromTargets:(NSArray<XCTarget *> *)targets {
    XCSourceFile *embedded = (XCSourceFile *) [self memberWithDisplayName:[framework fileName]];
    [self removeEmbeddedSourceFile:embedded fromTargets:targets];
}

//This is an added function. From: https://github.com/appsquickly/XcodeEditor/issues/62
- (void)removeEmbeddedSourceFile:(XCSourceFile *)sourceFile fromTargets:(NSArray *)targets {
    for (XCTarget *target in targets) {
        [target removeEmbedded:sourceFile];
    }
}
